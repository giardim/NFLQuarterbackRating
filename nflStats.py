...
def drawGui(qbList, ratingList):
    ...
    #creating widgits
    nameLabel = Label(root, text = "Quarterback Name", font = 25)
    ratingLabel = Label(root, text = "Rating", font  = 15)
    titleLabel = Label(root, text = "Top 5 quarterbacks this week", font = 15)
    qb1Label = Label(root, text = qbList[0], font = 15)
    qb2Label = Label(root, text = qbList[1], font = 15)
    qb3Label = Label(root, text = qbList[2], font = 15)
    qb4Label = Label(root, text = qbList[3], font = 15)
    qb5Label = Label(root, text = qbList[4], font = 15)
    rt1Label = Label(root, text = ratingList[0], font = 15)
    rt2Label = Label(root, text = ratingList[1], font = 15)
    rt3Label = Label(root, text = ratingList[2], font = 15)
    rt4Label = Label(root, text = ratingList[3], font = 15)
    rt5Label = Label(root, text = ratingList[4], font = 15)
